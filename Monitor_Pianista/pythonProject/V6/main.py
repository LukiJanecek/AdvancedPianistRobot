...
if Online:
    ...
    # logo_path = 'C:/Users/Adam Bátrla/Documents/GitHub/Klavirista_GUI/V5/450 FEI-CZ.png'
else:
...
window = sg.Window('Klavirista GUI', layout, no_titlebar=True, size=(1024, 768), finalize=True,keep_on_top=True)
